...
const styles = StyleSheet.create({
  ...
  detailLabel: {
    ...
    textTransform: 'uppercase',
    marginBottom: 8,
    marginTop: Platform.OS === 'web' ? 14 : 2,
  },
  ...
  chipText:     { color: C.textSec, fontSize: Platform.OS === 'web' ? 12 : 13, fontWeight: '600' },
  ...
  checkboxLabel: { color: C.textSec, fontSize: Platform.OS === 'web' ? 13 : 14, fontWeight: '600' },
  ...
  dateText: { color: C.text, fontSize: Platform.OS === 'web' ? 13 : 14, flex: 1 },
